...
base_df <- read_parquet("input/data_prep/darwinian_basin_single.parquet")
...
saveRDS(fit_gomp, file.path("output/model", "basin_darwinian_gompertz.rds"))


# stan_survdata <- readRDS("output/stan_survdata_basin_darwinian_multiple.rds")
