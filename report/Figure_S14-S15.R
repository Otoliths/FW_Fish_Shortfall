# Supplementary Figure S14 Temporal decline in documentation lags following taxonomic description
# Supplementary Figure S15 Global patterns and delays in first georeferenced freshwater fish records following taxonomic description
...
ggsave(
  filename = "figures/supplement/Figure_S14.png",
  width    = 20,
  height   = 12,
  units    = "cm",
  dpi      = 300
...
anim_save("figures/supplement/Figure_S15_map.gif", animation = anim_map)
anim_save("figures/supplement/Figure_S15_lat.gif", animation = anim_lat)
anim_save("figures/supplement/Figure_S15_lag.gif", animation = anim_lag)
...
ggsave("figures/supplement/Figure_S15.png",dpi = 300, units = "cm", width = 21, height = 18)