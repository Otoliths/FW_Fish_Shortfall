...
# combine
p1+p2
ggsave("figures/supplement/Figure_S19_A.png", width = 20, height = 8, units = "cm", dpi = 300)
################################################################################
df <- data %>%
...
ggsave("figures/supplement/Figure_S19_B.png", width = 12, height = 10, units = "cm", dpi = 300)
################################################################################
library(arrow)
...
ggsave("figures/supplement/Figure_S19_C.png", width = 10, height = 12, units = "cm", dpi = 300)
