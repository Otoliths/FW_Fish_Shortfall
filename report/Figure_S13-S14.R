...
library(ggpmisc)
library(patchwork)
basin_wallacean <- readRDS("output/stan_survdata_basin_wallacean.rds")
...
basin_darwinian <- readRDS("output/stan_survdata_basin_darwinian.rds")
...
ggsave(
  filename = "figures/supplement/Figure_S13.png",
  width    = 20,
  height   = 12,
  units    = "cm",
  dpi      = 300
...
anim_save("figures/supplement/Figure_S14_map.gif", animation = anim_map)
anim_save("figures/supplement/Figure_S14_lat.gif", animation = anim_lat)
anim_save("figures/supplement/Figure_S14_lag.gif", animation = anim_lag)
...
ggsave("figures/supplement/Figure_S14.png",dpi = 300, units = "cm", width = 21, height = 18)