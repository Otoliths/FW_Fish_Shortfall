---
title: "Fig.3 Shortfall scenarios vs hotspots"
output:
  html_document:
    toc: true
    toc_depth: 2
...
library(viridis)
library(scales)
# https://github.com/teunbrand/legendry/issues/80
# If you're on Windows you may try to go to 'Tools > Global options > General > Graphics > Backend' and set this to Cairo/Cairo PNG/AGG. 
# The default windows PNG device is a bit neglected and doesn't support more modern features and has bad anti aliasing.
library(legendry) 
library(here)
...
## Panel A: scenario × hotspot counts
