...
# Sensitivity of shortfall‐combination scenario classification to quantile thresholds
...
p1 <- ggplot(
  ...
  geom_vline(xintercept = 0.30, linetype = "dashed", linewidth = 0.8) +
...
final_plot
ggsave("figures/supplement/Figure_S22.png",width = 21, height = 10, units = "cm")
