...
# ------------------------------------------------------------------------------
# 4. Pre-split data by realm (use only species with observed discovery times)
# ------------------------------------------------------------------------------
...
summary_L_varwise_rel$realm <- factor(summary_L_varwise_rel$realm,levels = c( "Nearctic","Neotropic","Palearctic",
                                                                              "Afrotropic","Indomalayan","Australasian","Oceanian"))

p1 <- ggplot(summary_L_varwise_rel, aes(x = rel_imp_median, y = variable, fill = realm)) +
