# ------------------------------------------------------------------------------
# Supplementary Figure S18-S19 Principal component analysis (PCA) of Sustainable Development Goal (SDG)
# ------------------------------------------------------------------------------
...
ggsave("figures/supplement/Figure_S18.png",dpi = 300, units = "cm", width = 18, height = 16)
...
autoplot(sdg.pca, data = country_sdg, 
  ...
  theme(panel.grid.minor = element_blank(),
        ...
        legend.text = element_text(size = 6),
        legend.title = element_text(size = 7))
ggsave("figures/supplement/Figure_S19.png",dpi = 300, units = "cm", width = 18, height = 16)
